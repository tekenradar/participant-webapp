...
<figure className="figure mb-2 text-center w-100">
  <img className="figure-img img-fluid" style="max-width:600px;width:100%;" src="/assets/images/locaties_tekenbeten.jpeg" alt="Gemelde locaties van tekenbeten bij volwassen en kinderen">
...
<figure className="figure mb-2 text-center w-100">
  <img className="figure-img img-fluid" style="max-width:600px;width:100%;" src="/assets/images/tekenbeten_2020_prov.jpeg" alt="Gemelde tekenbeten en 2020 per provincie per 100.000 inwoners">
  <figcaption className="figure-caption">Bron: Tekenradar.nl</figcaption>
</figure>
