...
<figure className="w-full flex justify-center items-center my-16">
  <img
    width={294}
    src="/static/images/logo-WUR2.png"
    alt="Logo Wageningen University & Research"
   />
  <figcaption className="Logo Wageningen University & Research"></figcaption>
</figure>
