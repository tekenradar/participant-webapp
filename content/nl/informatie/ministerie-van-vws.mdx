---
title: Financiers - Ministerie van Volksgezondheid, Welzijn en Sport (VWS)
...
<figure className="w-full flex justify-center items-center my-16">
  <img
    width={250}
    src="/static/images/logo-vws2.png"
    alt="Logo Ministerie van Volksgezondheid, Welzijn en Sport (VWS)"
   />
</figure>
