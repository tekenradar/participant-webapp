---
title: Privacyverklaring Tekenradar
---
...
Voor dit doel wordt onder andere gebruik gemaakt van het loggen (bewaren) van activiteit op de website in een zogenaamd logbestand. Wij loggen bijvoorbeeld het aanmaken van accounts op Tekenradar en hierbij verwerken wij een identificatiecode (ID) dat is gekoppeld aan je e-mailadres.
...
Wij kunnen jouw emailadres gebruiken om maximaal 5 keer per jaar een nieuwsbrief te versturen. Hier moet je wel eerst toestemming voor geven. Dit kun je doen door je aan te melden in “Mijn tekenradar” na inloggen op de website. Tekenradar.nl biedt dan een nieuwsbrief aan waarmee deelnemers geïnformeerd worden over tekenbeetmeldingen, ander nieuws over tekenbeten en lymeziekte, vervolgonderzoeken en aanverwante zaken. Iedere nieuwsbrief bevat een link waarmee je je weer kunt afmelden. Als je je niet aanmeldt of weer afmeldt dan zul je geen nieuwsbrieven (meer) ontvangen. De verzendlijst van de nieuwsbrief wordt niet aan derden verstrekt.
