...
import { removeProfile } from '@/actions/user/profiles';
...
const DeleteProfileDialog: React.FC<DeleteProfileDialogProps> = (props) => {
    ...
    const onDelete = (e: React.MouseEvent<HTMLButtonElement>) => {
        ...
        startTransition(async () => {
            const resp = await removeProfile(props.profileID, exitSurveyResponse);
            if (!resp || resp.error) {
